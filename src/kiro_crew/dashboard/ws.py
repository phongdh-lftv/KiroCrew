            ...
            if msg.type == WSMsgType.TEXT:
                try:
                    ...
                    if msg_type == "subscribe_logs":
                        ...
                        # decision, so EVERY decision leaves an audit record —
                        # grant and deny alike, mirroring subscribe_logs.
                        # Rate concerns belong to the audit sinks (and the
                        # client throttles emits per slot), not to a skip here.
                        if _relayed:
